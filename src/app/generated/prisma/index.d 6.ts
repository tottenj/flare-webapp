...
export namespace Prisma {
  ...
  */
  ...
  export type FlareUserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "account_type" | "user_id", ExtArgs["result"]["flareUser"]>
  ...
  interface FlareUserFieldRefs {
    ...
    readonly account_type: FieldRef<"FlareUser", 'String'>
  ...
  export type FlareUserWhereInput = {
    ...
    account_type?: StringFilter<"FlareUser"> | string
  ...
  export type FlareUserScalarWhereWithAggregatesInput = {
    ...
    account_type?: StringWithAggregatesFilter<"FlareUser"> | string
